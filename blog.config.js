...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '光灿', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '今天吃饭了吗🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'guangcan.icu', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '光灿, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'guangcan0311@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  RANDOM_IMAGE_URL: process.env.NEXT_PUBLIC_RANDOM_IMAGE_URL || 'https://imgapi.xl0408.top/index.php', // 随机图片API,如果未配置下面的关键字，主页封面，头像，文章封面图都会被替换为随机图片
  ...
  WIDGET_PET_LINK:
    ...
    'https://imuncle.github.io/live2d/model/xiaomai/xiaomai.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '7351366698', // 对应歌单的 id
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'pinglun-three-phi.vercel.app', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'huangguangcan/Utterance', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/
